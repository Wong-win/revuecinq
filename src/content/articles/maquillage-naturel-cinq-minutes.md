...
1. **Un correcteur** — pas un fond de teint, pas une BB crème. Un correcteur, dans deux teintes : une exacte, une légèrement plus claire pour le dessous de l'œil. Le correcteur s'applique là où il y a quelque chose à corriger, pas sur tout le visage.
2. **Une crème teintée** — optionnelle, mais utile pour unifier sans masquer. On l'applique au doigt, par tapotements, sur les zones rouges et les irrégularités. Le but n'est pas de couvrir, c'est d'égaliser.
3. **Un mascara** — un seul, noir ou brun, qui allonge sans faire de paquets. La brosse fait le mascara ; choisir une brosse adaptée à ses cils vaut tous les sérums.
4. **Un fard à joues** — crème ou poudre, dans une couleur qui imite celle qu'on a naturellement quand on sort du froid. Pêche, rose frais, beige rosé. Jamais orangé.
5. **Un baume teinté pour les lèvres** — pas un rouge à lèvres, pas un gloss. Un baume qui colore légèrement, qui hydrate, et qui tient sans laisser de trace sur le verre.
